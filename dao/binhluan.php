...
function binhluan_insert($id_user , $id_product , $ngaybl, $noidung){
    $sql = "INSERT INTO comment(id_user, id_product, ngaybl, noidung) VALUES (?,?,?,?)";
    pdo_execute($sql, $id_user , $id_product , $ngaybl, $noidung);
}
